...
Gloamwire does **not** yet provide a state cache, command framework, voice media transport, complete REST endpoint/model coverage, Gateway compression/ETF encoding, or every Discord dispatch model. See [ROADMAP.md](ROADMAP.md) for the phased implementation plan.
...
use gloamwire::gateway::{
    GatewayConfig, GatewayConnection, GatewayEvent, GatewayIntents, TypedDispatchEvent,
};
